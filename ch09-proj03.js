...
document.addEventListener("DOMContentLoaded", function() {
  // Parse the JSON data from the provided files (assuming the data is loaded via script tags)
  ...
  document.getElementById("btnSave").addEventListener("click", function(event) {
    ...
    if (userIndex !== -1) {
        ...
        const userList = document.querySelector(".UserList ul");
        const selectedUser = userList.querySelector(`li[data-user-id="${userId}"]`);
        if (selectedUser) {
